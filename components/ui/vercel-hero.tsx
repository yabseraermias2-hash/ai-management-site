...
const floatingCards = [
  { title: "Model Health", value: "Optimal", change: "+2.4%", positive: true, top: "10%", left: "2%" },
  { title: "Active Agents", value: "1,847", change: "+124 today", positive: true, top: "60%", left: "1%" },
  { title: "Token Usage", value: "4.2B", change: "this month", positive: true, top: "20%", right: "2%" },
